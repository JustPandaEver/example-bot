...
const { convertSticker, mp4ToWebp } = require("./converter.js")
const isUrl = (url) => {
...
exports.WAConnection = _WAConnection => {
	...
	let packname = options.pack || "︎ ︎ ︎"
	let author = options.author || "︎ ︎ ︎"
...
exports.serialize = async (xinz, msg) => {
    ...
    try {
        ...
        msg.quotedMsg.body = (ane.type === 'conversation' && ane.conversation) ? ane.conversation : (ane.type == 'imageMessage') && ane.imageMessage.caption ? ane.imageMessage.caption : (ane.type == 'documentMessage') && ane.documentMessage.caption ? ane.documentMessage.caption : (ane.type == 'videoMessage') && ane.videoMessage.caption ? ane.videoMessage.caption : (ane.type == 'extendedTextMessage') && ane.extendedTextMessage.text ? ane.extendedTextMessage.text : (ane.type == 'listResponseMessage') && ane.listResponseMessage.singleSelectReply.selectedRowId ? ane.listResponseMessage.singleSelectReply.selectedRowId : (anu.type == 'buttonsResponseMessage') && ane.buttonsResponseMessage.selectedButtonId ? ane.buttonsResponseMessage.selectedButtonId : ''
